...
const ContactPage = () => (
  <section className="section contact-section">
    ...
    <motion.p className="page-subtitle" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }} style={{ maxWidth: 500 }}>
      Disponible pour un stage de Master PFE, CDD ou CDI à partir de Septembre/Octobre 2026.
    </motion.p>

    <div className="contact-grid">
      <GlassCard delay={0}>
        <h2 className="section-title" style={{ marginBottom: 20 }}>Me contacter</h2>
      ...
      <GlassCard delay={0.1}>
        <h2 className="section-title" style={{ marginBottom: 20 }}>Disponibilité</h2>
        <ul className="avail-list">
          <li><span className="dot-green" /> Stage PFE (5–6 mois)</li>
          <li><span className="dot-green" /> Alternance</li>
        ...
        <p className="avail-note">
          ...
          conception mécanique, simulation numérique, R&D.
        </p>
      </GlassCard>

      <GlassCard delay={0.15}>
        <h2 className="section-title" style={{ marginBottom: 20 }}>À propos de ce site</h2>
        <p className="about-text" style={{ fontSize: '0.9rem', lineHeight: 1.6 }}>
          Site web statique construit avec <strong>React</strong>, <strong>Vite</strong> et <strong>Framer Motion</strong>.
          Thème <strong>Liquid Glass</strong> avec distorsion lensée (SVG filters) et reflets spéculaires.
          Déployé sur <strong>GitHub Pages</strong>.
        </p>
      </GlassCard>
    </div>
  </section>
